...
<template>
  <div class="documents-table-container m-1 p-5">

    <div class="card px-3">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h6 class="mb-3 flex-grow-3">Documents Table</h6>
        <div class="d-flex flex-grow-2">
          <input type="text" v-model="filterText" class="form-control m-3" placeholder="Search By...">
          <a class="btn btn-link text-green "  @click="openAddDocumentView(document)" href="javascript:;">
            <i class="fas fa-add text-green ms-2" aria-hidden="true"></i>
          </a>
        </div>
      </div>
      <div class="card-body px-0 pt-0 pb-2">
            ...
            <tbody>
              <tr v-for="(document, index) in documents" :key="index">
                ...
                <td class="align-middle text-center text-sm">
                  <span class="badge badge- bg-gradient-warning">{{ document.status }}</span>
                </td>
                <td class="align-middle text-center">
